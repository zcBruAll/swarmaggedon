        ...
        <div className="patch-notes-container" ref={containerRef}>
            ...
            {isOpen && (
                <div className="patch-notes-modal modal">
                    <div className="patch-notes-title">{t('patchNotes.title')}</div>
                                ...
                                {TYPE_ORDER.map(type => {
                                    ...
                                    return (
                                        <div key={type} className="patch-type-subgroup">
                                            <div className={`patch-type-header ${type}`}>
                                                {t(`patchNotes.types.${type}`)}
                                            </div>
            ...
            <button className="button" onClick={toggleOpen}>
                {isOpen ? t('patchNotes.close') : t('patchNotes.button')}
            </button>
        </div>
    );
}